...
public class ClubStatisticsTableModel extends AbstractTableModel {
    private static List<ClubStatistics> clubStatisticsList;

    private final String[] columnNames = new String[] {
            "Наименование клуба", "Турнирное положение", "Количество сыгранных матчей", "Победы",
    ...
    public ClubStatisticsTableModel(List<ClubStatistics> clubStatisticsList)
    {
